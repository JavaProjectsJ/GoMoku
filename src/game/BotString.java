...
/**
 * Class used for giving life/IQ to the BOTs
 * 
 * @author jmpfbmx
 * @version 1.0
 * @since 1.0
...
public class BotString extends Player {
	...
	/**
	 * Bot constructor, here it is being created and its name and turn is being set
	 * 
	 * @param name (Name of the bot generated by Database enum)
	 * @param turn (Turn of the bot)
	 * @see Database
	 */
	...
	/**
	 * Method for getting the piece of the other player
	 * 
	 * @return the piece of the other player.
	 * @see Pieces
	 */
	...
	/**
	 * Boolean that detects if it is the first piece or not.
	 * 
	 * @param board
	 * @return true if it is the first movement
	 * @see Board
	 */
	...
	/**
	 * Method for getting the best coordinate is done using patterns of Strings
	 * 
	 * @param board
	 * @return the result of the best coordinate where the piece can be set.
	 * @see Board
	 * @see BotString#firstPiece(Board)
	 * @see BotString#piezes()
	 * @see BotString#getPattern(String)
	 * @see BotString#translatePosition(int[], int)
	 */
	@Override
	...
	/**
	 * Patterns for the bot, the best combinations that can be defended resides here
	 * 
	 * @param s (Symbol of the piece, it could be "X" or "O")
	 * @return the patterns with the piece
	 */
	...
	/**
	 * Method used for increasing the positions depending on the patterns
	 * 
	 * @param patternN (The number of the pattern)
	 * @return The increase
	 */
	...
	/**
	 * Translate the position of the String from String to the coordinate X and Y
	 * 
	 * @param position to translate
	 * @param patternN (The number of the pattern)
	 * @return The translated position
	 * @see BotString#crossWise1(int)
	 * @see BotString#crossWise2(int)
	 */
	...
	/**
	 * Translate the position of the String from String to the coordinate X and Y
	 * at the first crosswise
	 * 
	 * @param nRow (number of the row to be translated)
	 * @return the translated position
	 */
