...
public class BotString extends Player {
	...
	/**
	 * Bot constructor, here is being created and it name and turn is being set
	 * 
	 ...
	 * 
	 * @param board
	 * @return true if is the first movement
	 * @see Board
	 */
	...
	/**
	 * Patterns for the bot, here resides the best combinations that can be defended
	 * 
